      ...
      <div className="flex items-center gap-6 relative">
        <div className="relative">
            ...
            onClick={()=>{setShowCredits(!showCredits);setShowProfile(false)}}
             whileHover={{scale:1.07}} whileTap={{scale:0.97}} className="flex items-center gap-1
    ...
    >Buy More Credits
         ...
         <div className="relative">
            ...
            onClick={()=>{setShowProfile(!showProfile);setShowCredits(false)}}
             whileHover={{scale:1.1}} whileTap={{scale:0.97}} className="flex items-center gap-1
            px-4 py-2 rounded-full
            bg-white/10 border border-white/20
            text-white text-sm cursor-pointer
            shadow-md">
...
function MenuBar({onClick,text,red}){
  return(
    <div
